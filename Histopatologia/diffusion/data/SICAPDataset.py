...
# ------------------------------------- #
class SICAPDatasetImages(Dataset):
    def __init__(self,
                data_csv,
                data_root,
                size=None,
        ...
        self.labels = {
            ...
            "relative_file_path_": [l + '.jpg' for l in self.image_ids],
            "file_path_": [os.path.join(self.data_root, l + '.jpg') for l in self.image_ids],
...
# ----------------------- #
class SICAPDatasetLatents(Dataset):
    def __init__(self,
                root,
                data_csv,
                model='sdxl-vae',
