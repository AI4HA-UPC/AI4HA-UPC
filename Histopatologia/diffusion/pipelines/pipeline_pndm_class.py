...
class PNDMPipelineClass(DiffusionPipeline): 
    r"""
    ...
    def __call__(
        ...
        for t in self.progress_bar(self.scheduler.timesteps):
            ...
            if self.do_classifier_free_guidance:
                model_output_cond = self.unet(sample=image,
                                            timestep=t,
                                            class_labels=class_cond).sample
                model_output_uncond = self.unet(sample=image,
                                                timestep=t,
                                                class_labels=labels_uncond).sample
