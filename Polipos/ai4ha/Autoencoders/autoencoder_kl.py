...
# Now the forward method of AutoencoderKL returns the posterior distribution so
# it can be trained with KL loss
...
class AutoencoderKL(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        Args:
            ...
            Now returns the output of the decoder and the posterior distribution
        """
        x = sample
        ...
        return DecoderOutput(sample=dec), posterior
