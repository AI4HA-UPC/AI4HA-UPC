...
class SunDataset(Dataset):
    ...
    def __init__(self,
        ...
        for s in ldirs:
            masks_root = f'SUN-SEG-Annotation/{folder}/{s}/GT'
            ...
            for case in os.listdir(root_split_path):
                ...
                if os.path.isdir(
                    ...
                    print(len(os.listdir(os.path.join(case_path))))
    ...
    def __getitem__(self, idx):
        ...
        # if self.raw:
        #     example["image"] = processed["image"].astype(np.uint8)
        # else:
...
class ExamplesTrain(SunDataset):
    ...
    def __init__(self,
        ...
        super().__init__(size=size,
                         ...
                         squarify=squarify,
                         raw=raw,
                         local=local, negatives=negatives)


class ExamplesVal(SunDataset):

    def __init__(self,
                 folder='TestEasyDataset',
                 size=256,
                 augmentation=False,
                 squarify=False,
                 raw=False,
