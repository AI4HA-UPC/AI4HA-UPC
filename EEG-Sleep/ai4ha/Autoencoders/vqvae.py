...
# @ 15/01/2023
# Modified so it can be used for training
# Now the forward method of VQModel returns loss of the codebook
...
from diffusers.models.autoencoders.vae import Decoder, DecoderOutput, Encoder, VectorQuantizer


def VQVAE_exp_name(cfg):
    """_summary_
    ...
    name += f"-l{cfg['model']['params']['block_out_channels'][0]}-{channels_growth(cfg)}"
...
class VQModel(ModelMixin, ConfigMixin):
    ...
    def get_last_layer(self):
        """_Returns the decoder last layer_

        Needed for VAE KL with discriminator
    ...
    def decode(
        ...
        return DecoderOutput(sample=dec), emb_loss
    ...
    def forward(
        ...
        return DecoderOutput(sample=dec), loss
