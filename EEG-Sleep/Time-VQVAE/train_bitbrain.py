...
def load_args():
    ...
    parser.add_argument('--dataset_name', help="e.g., PTBXL.", default='Sleep-EDF_Fpz-Cz')
...
if __name__ == '__main__':
    ...
    train_dataset = sleep_bitbrain(path='../../data/sleep/train_set/')
    test_dataset = sleep_bitbrain(path='../../data/sleep/test_set/')
    # train
    if config["stage"] == 1:
        train_loader = DataLoader(train_dataset, batch_size=config["dataset"]["batch_sizes"]["stage1"], 
            num_workers=30, shuffle=True, drop_last=True)
