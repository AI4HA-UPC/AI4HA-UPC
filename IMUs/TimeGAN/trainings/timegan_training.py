...
from models.timegan_v4 import TimeGAN
import argparse
import glob
import pandas as pd
import random
...
import pickle
from metrics.timegan_v2.metric_utils import feature_prediction, one_step_ahead_prediction, reidentify_score
        ...
        for i in range(2):
        	with torch.no_grad():
        		for step in range(len(T)):
        			...
        			#labels = torch.tensor(labels[step], dtype=torch.int64)
