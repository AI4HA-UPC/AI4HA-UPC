...
class SUNPlusDataset(Dataset):
    ...
    def __init__(self,
        ...
        # SUN data
        # base_path = f'/data/atormos/sundatabase/640px'
        base_path = f'/data/atormos/512px/sundatabase'
...
class ExamplesTrain(SUNPlusDataset):
    ...
    def __init__(self,
        ...
        super().__init__(dataset_dir=dataset_dir,
                         ...
                         negatives=negatives,
                         cases=TRAIN_CASES, fld=fld)


class ExamplesTest(SUNPlusDataset):
    def __init__(self,
                 size=None,
                 dataset_dir=None,
                 data_csv=None,
        ...
        super().__init__(size=size,
                         ...
                         data_csv=data_csv,
                         folder='TestHardDataset/Unseen/',
                         data_root=data_root,
                         interpolation=interpolation,
                         augmentation=augmentation,
                         negatives=negatives,
                         cases=TEST_UNSEEN_CASES, fld=fld)
