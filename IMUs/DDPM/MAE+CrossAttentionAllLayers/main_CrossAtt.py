...
from models.unet_1d_crossAttentionAllLayers import CondUNet1DModel
from util import instantiate_from_config, load_config, time_management
from pipelines.pipeline_ddpm_1d import DDPMPipeline
...
def main(config):
    ...
    if accelerator.is_main_process:
        ...
        """np.savez(f"{BASE_DIR}/samples/sampled_data_{config['dataset']['store_name']}.npz",
