...
def load_args():
    ...
    parser.add_argument('--config', type=str, help="Path to the config data  file.",
                        default=get_root_dir().joinpath('configs', 'config_ptbxl.yaml'))
    parser.add_argument('--dataset_name', help="e.g., PTBXL.", default='PTBXL_100-combined')
...
if __name__ == '__main__':
    ...
    train_dataset = multi_channel(filename='../../data/ecg/ptbxl_100-combined_train.csv')
    test_dataset = multi_channel(filename='../../data/ecg/ptbxl_100-combined_test.csv')
    # train
