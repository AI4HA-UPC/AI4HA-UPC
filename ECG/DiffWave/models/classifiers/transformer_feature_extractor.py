...
class TransformerClassifierFeatureExtractor(nn.Module):
    ...
    def __init__(
        ...
        super(TransformerClassifierFeatureExtractor, self).__init__()
...
if __name__ == "__main__":
    ...
    model = TransformerClassifierFeatureExtractor(
        seq_length=width_sequence, seq_channels=height_sequence, n_classes=num_classes, class_logits="avgpool"
    )
    y = model(data)
    print(y)
